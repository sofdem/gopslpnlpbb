...
##            for t in range(1, 1):
                ...
                t_infl_min= BT_one_st.build_common_model(instance, Z, C, D, P0, P1, K, K, k, t,  'TANK_MIN', 'full_SOS', accuracy=0.01, envelop=0.5, oagap=OA_GAP, arcvals=None)
                t_infl_max= BT_one_st.build_common_model(instance, Z, C, D, P0, P1, K, K, k, t,  'TANK_MAX', 'full_SOS', accuracy=0.01, envelop=0.5, oagap=OA_GAP, arcvals=None)
...
##            for t in range(1, 1):
                ...
                if k.control:
                    ...
                    if ((mm, nn), t) in P1:
                        ...
                        dh_off_mi= BT_one_st.build_common_model(instance, Z, C, D, P0, P1, mm, nn, k, t, 'PUMP_OFF_MIN', 'full_SOS', accuracy=0.05, envelop=0.5, oagap=OA_GAP, arcvals=None)
                        dh_off_ma= BT_one_st.build_common_model(instance, Z, C, D, P0, P1, mm, nn, k, t, 'PUMP_OFF_MAX', 'full_SOS', accuracy=0.05, envelop=0.5, oagap=OA_GAP, arcvals=None)
